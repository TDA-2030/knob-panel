...
static esp_err_t esp_box_init(void)
{
    ...
    snprintf(cmd_json, sizeof(cmd_json),
             ...
             "cmd_light_on->phoneme", "sr_lang", "cmd_light_on->str",
             "cmd_light_off->phoneme", "sr_lang", "cmd_light_off->str",
             h, s, v, "cmd_cc->phoneme", "sr_lang", "cmd_cc->str");
    esp_box_light_param_t def_light_param = {
        .gpio_r = -1,//brd->PMOD2->row1[1],
        .gpio_g = -1,//brd->PMOD2->row1[2],
        .gpio_b = -1,//brd->PMOD2->row1[3],
        .hue = 0,
        .brightness = 100,
        .saturation = 100,
        .power = false,
