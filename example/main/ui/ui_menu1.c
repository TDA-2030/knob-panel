...
static ui_menu_app_t menu[] = {
    {"Washing", &icon_washing, LV_COLOR_MAKE(100, 100, 200), ui_washing_init},
    {"Thermostat", &icon_fans, LV_COLOR_MAKE(200, 100, 100), ui_thermostat_init},
    {"Light", &icon_light, LV_COLOR_MAKE(200, 200, 100), ui_light_init},
};
...
{
    const int ox = 0, oy = 0;
    *x = ox + ((lv_trigo_sin(theta) * 50) >> LV_TRIGO_SHIFT);
    *y = oy + ((lv_trigo_sin(theta + 90) * 50) >> LV_TRIGO_SHIFT);
}
